  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        //creo un listview
        child: FutureBuilder(
          future: NoticiasApi.instance.obtenerNoticia(),
          ...
          children: [
            ListTile( //encabezado
              ...
              leading: CircleAvatar(
                child: Text("${noticia.creadoPor.nombre.substring(0,1).toUpperCase()}"),
              ),
            ),
            Container( //imagen
              ...
              child: Container(
                ...
                borderRadius: BorderRadius.circular(15),
                 image: DecorationImage(
                   image: (noticia.imgLink == '')?AssetImage("assets/no-image.png"):NetworkImage(noticia.imgLink),
                   fit: BoxFit.fill,
